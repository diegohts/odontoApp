...
// @Test
// @DisplayName("cadastrarPessoa - Deve devolver codigo HTTP 400 quando
// informações estão inválidas")
// void cadastrarPessoa1() throws Exception {
// var response =
// mockMvc.perform(MockMvcRequestBuilders.post(baseUrl)).andReturn().getResponse();

// Assertions.assertThat(response.getStatus()).isEqualTo(HttpStatus.BAD_REQUEST.value());
// }

// @Test
// @DisplayName("cadastrarPessoa - Deve retornar codigo HTTP 201 quando os dados
// estão válidos")
...
// var dadosDetalhamentoPessoa = new DadosDetalhamentoPessoa(1L, "Carina
// Laureano", "", "email@email.com",
// Genero.FEMININO, LocalDate.of(1997, 12, 21));
// var jsonEsperado =
// dadosDetalhamentoPessoaJson.write(dadosDetalhamentoPessoa).getJson();

// Mockito.when(this.pessoaService.cadastrar(Mockito.any(DadosCadastroPessoa.class)))
// .thenReturn(dadosDetalhamentoPessoa);
...
// @Test
// @DisplayName("cadastrarPessoa - Deve devolver codigo HTTP 400 ao passar um
// email já cadastrado")
...
// Mockito.when(this.pessoaService.cadastrar(Mockito.any(DadosCadastroPessoa.class)))
// .thenThrow(new ValidacaoException("Email já cadastrado"));
...
// Assertions.assertThat(response.getStatus()).isEqualTo(HttpStatus.BAD_REQUEST.value());
// Assertions.assertThat(response.getContentAsString()).isEqualTo("Email já
// cadastrado");
// }
// }
